...
class WeatherApplication : Application() {
    ...
    val database2 by lazy{ UserRoomDatabase.getDatabase(this, applicationScope)}
    ...
    val repository by lazy{ WeatherRepository.getInstance(database.weatherDao(), database2.userDao(),
        applicationScope)}
}